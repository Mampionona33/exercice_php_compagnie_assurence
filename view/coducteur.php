...
function form_create()
{
    ...
    $content .= '<input type="date" name="date_naissance" id="date_naissance" value="2000-01-01">';
    $content .= '</div>';

    $content .= '<div>';
    $content .= '<label for="annee_obt_permis">Année d\'obtention du permis</label>';
    $content .= '<input type="number" min=1970 name="annee_obt_permis" id="annee_obt_permis" required>';
    $content .= '</div>';
